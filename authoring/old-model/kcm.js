...
function getAppCannedDatabases(plutilCommand, userId, pipelineWorkflowStatuses, callback) {
  ...
  var createAllUsers = function() {
    ...
    db.serialize(function() {
      ...
      db.run("CREATE TABLE NodePlays (episode_id TEXT PRIMARY KEY ASC, batch_id TEXT, user_id TEXT, node_id TEXT, mastery_node_id TEXT, start_date REAL, last_event_date REAL, ended_pauses_time REAL, curr_pause_start_date REAL, score INTEGER)")
