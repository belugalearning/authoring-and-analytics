...
module.exports = function(config) {
  ...
  server.sessionService = sessionService.createService(model.kcm)
  server.routeHandlers = routeHandlers.init(config, model)
...
function setupRoutes() {
  ...
  server.post('/content/problem/:problemId/perform-update', server.routeHandlers.content.editProblem.performUpdate)
  server.get('/content/problem/:problemId/download-pdef-plist', function(req,res) { server.routeHandlers.content.editProblem.sendPList(req, res, true) })
  server.get('/content/problem/:problemId/view-pdef-plist', function(req,res) { server.routeHandlers.content.editProblem.sendPList(req, res, false) })
  server.get('/content/problem/:problemId/replace-pdef-plist', server.routeHandlers.content.editProblem.replacePListPage)
  server.post('/content/problem/:problemId/replace-pdef-plist', server.routeHandlers.content.editProblem.performReplacePList)
  ...
  server.get('/kcm/problem/:problemId', server.routeHandlers.content.editProblem.problemDetailPage)
}
