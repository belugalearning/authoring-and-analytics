  ...
  return {
    ...
    , getMap: function(req, res) {
      var map = {
        ...
        , nodes:kcm.docStores.nodes
        , binaryRelations:{}
        , chainedBinaryRelations:{}
        , update_seq:kcm.update_seq
        , pipelineWorkflowStatuses:req.app.config.authoring.pipelineWorkflowStatuses
        , problems:kcm.docStores.problems
        , tools:kcm.docStores.tools
      }
      ...
      ;(function decompileNext(file) {
        ...
        decompileFormPList(file, function(e, decompiledPDef) {
          ...
          if (numDecompiled < numFiles) {
            ...
            ;(function rec(pdef) {
              kcmController.insertProblem(pdef, plId, plRev, cnId, cnRev, function(e,r,b) {
